					...
					<section>
						...
						<div className="space-y-3">
							{recentTestsData.slice(0, showMoreRecent ? 4 : 2).map((test, idx) => (
								<div key={idx} className="border p-4 rounded-md bg-white shadow-md cursor-pointer" onClick={() => { navigate(test.type === "Test" ? paths.manager.tests.ROOT : paths.manager.scenario._layout) }}>

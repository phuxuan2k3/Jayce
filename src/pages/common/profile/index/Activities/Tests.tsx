...
import { useGetCandidateAttemptsQuery, useLazyGetTestsByTestIdQuery } from '../../../../../features/tests/api/test.api-gen';
            ...
            <div className="space-y-4">
                {topicLoading ? (
                    ...
                    testTopics.map((item, index) => (
                        <div key={index} className="bg-[#eaf6f8] p-4 rounded-lg flex flex-col cursor-pointer" onClick={() => handleNavigateToTest(item.id)}>

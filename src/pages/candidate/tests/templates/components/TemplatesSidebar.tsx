...
import QuickAction from '../../../../../features/tests/ui2/QuickAction';
...
const TemplatesSidebar = ({ searchTerm, onSearchChange, onCreateNew }: TemplatesSidebarProps) => {
	...
	return (
		<div className="sticky top-2 max-h-[96vh] shadow-primary bg-white rounded-lg p-6 flex flex-col gap-6">
			<h3 className="text-xl font-bold mb-2 text-center">Template Actions</h3>
			...
			<div className="flex flex-col gap-4">
				<QuickAction
					...
					description="Design a custom prompt template"
					onClick={onCreateNew}
				/>
				...
				<QuickAction
					...
					title="Generate Test"
					description="Create a test using templates"

...
Command: npx gltfjsx@6.5.3 public/models/Jenny.glb -o src/pages/Interview/characters/Jenny/Avatar.jsx -r public 
*/
...
export function Avatar(props) {
  const { nodes, materials } = useGLTF('/models/Jenny.glb')
  const { animations: idleAnimation } = useFBX("/animations/Jenny_Idle.fbx");

                  ...
                  {openResource && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        >
                          <path
                            d="M20 5.62492C20 4.35927 21.026 3.33325 22.2917 3.33325H28.5417C29.8073 3.33325 30.8333 4.35927 30.8333 5.62492V14.9999H28.3333V5.83325H22.5V11.8749C22.5 13.1406 21.474 14.1666 20.2083 14.1666H14.1667V20.2083C14.1667 21.4739 13.1407 22.4999 11.875 22.4999H5.83334V28.3333H15V30.8333H5.62501C4.35936 30.8333 3.33334 29.8073 3.33334 28.5416V22.2916C3.33334 21.0259 4.35936 19.9999 5.62501 19.9999H11.6667V13.9583C11.6667 12.6926 12.6927 11.6666 13.9583 11.6666H20V5.62492ZM27.2917 16.6666C26.026 16.6666 25 17.6926 25 18.9583V24.9999H18.9583C17.6927 24.9999 16.6667 26.0259 16.6667 27.2916V33.5416C16.6667 34.8073 17.6927 35.8333 18.9583 35.8333H30.4167C33.4082 35.8333 35.8333 33.4081 35.8333 30.4166V18.9583C35.8333 17.6926 34.8073 16.6666 33.5417 16.6666H27.2917ZM27.5 25.2083V19.1666H33.3333V30.4166C33.3333 32.0274 32.0275 33.3333 30.4167 33.3333H19.1667V27.4999H25.2083C26.474 27.4999 27.5 26.4739 27.5 25.2083Z"
                            fill="#212121"
                          />
                        </svg>
                        ...
                        <div className="ps-3">
                          ...
                          <div className="text-sm text-gray-600">
                            Introduction to use our features
                          </div>
                        </div>
                      </div>

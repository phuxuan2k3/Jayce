...
const CandidateNavbar = ({ showNav = true }: { showNav?: boolean }) => {
  ...
  const [, setOpenResource] = useState(false);
      ...
      <div className=" lg:mx-12 px-6   ">
        <div className="relative h-[60px] flex items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            {showNav && (
              <div className="hidden w-full sm:flex sm:ml-10 sm:space-x-6 items-center justify-start"></div>
            )}
          </div>
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            >
              ...
              <Link
                ...
                className={classNames(
                  "flex mr-6 text-black text-20  icon-link items-center p-2 hover:text-primary hover:border-b-2 hover:border-primary-toned-500",
            ...
            >
              <Link
                to="/candidate/tests"
                className={classNames(
                  "flex mr-6 text-black icon-link items-center p-2 hover:text-primary hover:border-b-2 hover:border-primary-toned-500",
            ...
            >
              ...
              >
                <path
                  ...
                  fill="#212121"
                  className={classNames(
                    url.includes("/candidate/faq") ? "icon-select" : "icon-path"
                  )}
                />
              </svg>
              <div onClick={() => navigate("/candidate/faq")} className="ps-1">
            ...
            <div className="relative ml-3">
              <div>
                ...
                <div className="hidden lg:block relative">
                  ...
                  {isMenuOpen && (
                    // <Portal id="product">
                    <div className="absolute right-[1px] top-10 mt-2 w-48 bg-white border rounded shadow-lg z-50">
                      <Link
